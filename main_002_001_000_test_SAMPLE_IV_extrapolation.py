...
def main():
    ...
    for one_date in random_dates:
        ...
        V_hat_nlin1 = rnd.getfit(this_pf['tslm'].to_numpy(), this_pf['implied_volatility'].to_numpy(), rnd.INTERP_FACTR31)
        ...
        V_hat_extra = rnd.getfitextrapolated(this_pf['tslm'].to_numpy(), this_pf['implied_volatility'].to_numpy(), tslm_new, rnd.INTERP_FACTR31)
        ...
        plt.legend(['data', 'INTERP_FACTR31'])
